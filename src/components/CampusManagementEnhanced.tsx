        ...
        <Card className="lg:col-span-2 campus-shadow hover-lift bg-white/90 backdrop-blur-sm">
          ...
          <CardContent className="space-y-6 p-6">
            ...
            <div className="grid grid-cols-2 gap-6">
              ...
              {/* AI Recording Search Modal */}
              <Dialog open={showAIRecordingSearch} onOpenChange={setShowAIRecordingSearch}>
                <DialogContent className="max-w-3xl">
                  <DialogHeader>
                    <DialogTitle className="flex items-center gap-3 text-campus-navy">
                      ...
                      AI-Powered Recording Search
                    </DialogTitle>
                    <DialogDescription>
                      Tell me what topic you want to learn about, and I'll find the exact recording segment for you!
                    </DialogDescription>
                  </DialogHeader>
                  ...
                  <div className="space-y-6 py-4">
                    <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-4 rounded-xl border border-green-200">
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <h4 className="font-semibold text-campus-navy">Voice or Text Search</h4>
                      </div>
                      
                      <div className="space-y-3">
                        <Input
                          placeholder="e.g., 'Show me algorithms for sorting' or 'I want to learn about graph traversal'"
                    ...
                    {recordingSearchQuery && (
                      <div className="space-y-3">
                        <h4 className="font-semibold text-campus-navy">Found Recordings:</h4>
                        {searchRecordings(recordingSearchQuery).map((recording, index) => (
                          <div key={index} className="bg-white p-4 rounded-lg border border-gray-200 hover:border-green-300 transition-colors cursor-pointer">
                            <div className="flex items-start justify-between">
                              <div className="flex-1">
                                <h5 className="font-medium text-campus-navy">{recording.title}</h5>
                    ...
                    <div className="bg-blue-50 p-4 rounded-xl border border-blue-200">
                      ...
                      <p className="text-sm text-blue-700">
                        Try asking: "Show me the part about time complexity" or "I need help with sorting algorithms"
                      </p>
                    </div>
                  </div>
                </DialogContent>
              ...
              {/* Test Retake Modal */}
              <Dialog open={showRetakeTest} onOpenChange={setShowRetakeTest}>
                <DialogContent className="max-w-2xl">
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      {selectedAssessment && `Improve your score on: ${selectedAssessment.name}`}
                    </DialogDescription>
                  </DialogHeader>
                  ...
                  {selectedAssessment && (
                    <div className="space-y-6 py-4">
                      <div className="bg-gradient-to-r from-orange-50 to-red-50 p-4 rounded-xl border border-orange-200">
                        <h4 className="font-semibold text-campus-navy mb-3">Current Performance</h4>
                        <div className="flex items-center justify-between">
                      ...
                      <div className="bg-yellow-50 p-4 rounded-xl border border-yellow-200">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <span className="text-sm font-medium text-yellow-800">Retake Policy</span>
                        </div>
                        <p className="text-sm text-yellow-700">
                          • One retake allowed per assessment<br/>
                          • Higher score will be recorded<br/>
              ...
              {/* Tutor Recommendations Modal */}
              <Dialog open={showTutorRecommendations} onOpenChange={setShowTutorRecommendations}>
                <DialogContent className="max-w-3xl">
                  <DialogHeader>
                    <DialogTitle className="flex items-center gap-3 text-campus-navy">
                    ...
                    <DialogDescription>
                      Based on your CGPA of {studentInfo.gpa}, here are tailored learning opportunities
                    </DialogDescription>
                  </DialogHeader>
                  ...
                  <div className="space-y-6 py-4">
                    <div className="bg-gradient-to-r from-purple-50 to-pink-50 p-4 rounded-xl border border-purple-200">
                      <div className="flex items-center justify-between mb-3">
                        <h4 className="font-semibold text-campus-navy">Your Academic Standing</h4>
                        <Badge className={`${studentInfo.gpa >= 3.5 ? 'bg-green-500' : studentInfo.gpa >= 3.0 ? 'bg-blue-500' : 'bg-orange-500'} text-white`}>
                          CGPA: {studentInfo.gpa}
                        </Badge>
                      </div>
                      <p className="text-sm text-purple-700">
                        {studentInfo.gpa >= 3.5 ? 'Excellent performance! Advanced learning opportunities available.' :
                         studentInfo.gpa >= 3.0 ? 'Good progress! Enhancement programs recommended.' :
                         'Academic support available to help improve your performance.'}
                      </p>
                    </div>

                    <div className="space-y-4">
                      <h4 className="font-semibold text-campus-navy">Recommended Programs</h4>
                      {getTutorRecommendations(studentInfo.gpa).map((program, index) => (
                        <div key={index} className="bg-white p-4 rounded-lg border border-gray-200 hover:border-purple-300 transition-colors">
                          <div className="flex items-start justify-between">
                            <div className="flex-1">
                              <div className="flex items-center gap-2 mb-2">
                                <Badge variant="outline" className={`${
                                  program.type === 'Advanced Study Group' ? 'bg-green-50 text-green-600 border-green-200' :
                                  program.type === 'Academic Support' ? 'bg-orange-50 text-orange-600 border-orange-200' :
                                  'bg-blue-50 text-blue-600 border-blue-200'
                                }`}>
                                  {program.type}
                                </Badge>
                              </div>
                              <h5 className="font-medium text-campus-navy">{program.title}</h5>
                              <p className="text-sm text-muted-foreground mt-1">{program.time}</p>
                            </div>
                            <div className="flex items-center gap-3 ml-4">
                              <span className="text-sm text-muted-foreground">{program.spots} spots left</span>
                    ...
                    <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-4 rounded-xl border border-blue-200">
                      <div className="flex items-center gap-2 mb-2">
                        <Brain className="h-4 w-4 text-blue-600" />
                        <span className="text-sm font-medium text-blue-800">AI Tutor Assistant</span>
                      </div>
                      <p className="text-sm text-blue-700 mb-3">
                        Get 24/7 AI-powered tutoring support for instant help with course materials.
                      </p>
              ...
              <Dialog open={showPracticalTest} onOpenChange={setShowPracticalTest}>
                <DialogContent className="max-w-2xl">
                  <DialogHeader>
                    <DialogTitle className="flex items-center gap-3 text-campus-navy">
                    ...
                    <DialogDescription>
                      {selectedCourse && `Strengthen your understanding of ${selectedCourse.name}`}
                    </DialogDescription>
                  </DialogHeader>
                  
                  <div className="space-y-6 py-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-4 rounded-xl border border-blue-200 cursor-pointer hover:border-blue-300 transition-colors">
                        <div className="flex items-center gap-3 mb-2">
                          <Target className="h-5 w-5 text-blue-600" />
                          <h4 className="font-semibold text-campus-navy">Quick Quiz</h4>
                        </div>
                        <p className="text-sm text-blue-700 mb-3">5 questions • 10 minutes</p>
                        <Button size="sm" className="w-full bg-blue-500 hover:bg-blue-600 text-white">
                          Start Quiz
                        </Button>
                      </div>

                      <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-4 rounded-xl border border-green-200 cursor-pointer hover:border-green-300 transition-colors">
                        <div className="flex items-center gap-3 mb-2">
                          <BookOpen className="h-5 w-5 text-green-600" />
                          <h4 className="font-semibold text-campus-navy">Concept Review</h4>
                        </div>
                        <p className="text-sm text-green-700 mb-3">10 questions • 20 minutes</p>
                        <Button size="sm" className="w-full bg-green-500 hover:bg-green-600 text-white">
                          Begin Review
                        </Button>
                      </div>

                      <div className="bg-gradient-to-br from-orange-50 to-red-50 p-4 rounded-xl border border-orange-200 cursor-pointer hover:border-orange-300 transition-colors">
                        <div className="flex items-center gap-3 mb-2">
                          <Zap className="h-5 w-5 text-orange-600" />
                          <h4 className="font-semibold text-campus-navy">Speed Challenge</h4>
                        </div>
                        <p className="text-sm text-orange-700 mb-3">15 questions • 15 minutes</p>
                        <Button size="sm" className="w-full bg-orange-500 hover:bg-orange-600 text-white">
                          Take Challenge
                        </Button>
                      </div>

                      <div className="bg-gradient-to-br from-purple-50 to-pink-50 p-4 rounded-xl border border-purple-200 cursor-pointer hover:border-purple-300 transition-colors">
                        <div className="flex items-center gap-3 mb-2">
                          <Brain className="h-5 w-5 text-purple-600" />
                          <h4 className="font-semibold text-campus-navy">Mock Exam</h4>
                        </div>
                        <p className="text-sm text-purple-700 mb-3">25 questions • 45 minutes</p>
                    ...
                    <div className="bg-gradient-to-r from-yellow-50 to-orange-50 p-4 rounded-xl border border-yellow-200">
                      <h4 className="font-semibold text-campus-navy mb-3">Adaptive Learning</h4>
                      <p className="text-sm text-yellow-700 mb-3">
                        Our AI analyzes your performance and creates personalized practice questions targeting your weak areas.
                      </p>
                    ...
                    <div className="bg-gray-50 p-4 rounded-xl border border-gray-200">
                      <h4 className="font-semibold text-campus-navy mb-2">Recent Practice Scores</h4>
                      <div className="space-y-2">
                        <div className="flex justify-between items-center">
                          <span className="text-sm">Algorithms Quiz</span>
                          <Badge className="bg-green-500 text-white">92%</Badge>
                        </div>
                        <div className="flex justify-between items-center">
                          <span className="text-sm">Data Structures Review</span>
                          <Badge className="bg-blue-500 text-white">87%</Badge>
                        </div>
                        <div className="flex justify-between items-center">
                          <span className="text-sm">Speed Challenge</span>
                          <Badge className="bg-orange-500 text-white">78%</Badge>
                        </div>
                      </div>
                    </div>
                  </div>
